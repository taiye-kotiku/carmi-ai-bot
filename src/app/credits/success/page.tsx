        ...
        const checkPayment = async () => {
            try {
                ...
                if (data.status === "completed") {
                    ...
                    // Payment webhook might not have arrived yet, retry
            ...
            <div className="max-w-md w-full text-center">
                ...
                {status === "pending" && (
                    <div className="bg-white rounded-3xl border border-yellow-200 p-8 shadow-lg">
                        ...
                        <p className="text-gray-600 mb-6">
                            התשלום שלך התקבל ונמצא בעיבוד. הקרדיטים יתווספו בדקות
                            הקרובות.
                        </p>
                        <Link
                            href="/dashboard"
                ...
                {status === "error" && (
                    <div className="bg-white rounded-3xl border border-red-200 p-8 shadow-lg">
                        ...
                        <p className="text-gray-600 mb-6">
                            לא הצלחנו לאמת את התשלום. אם חויבת, אנא צור קשר איתנו
                            ונטפל בזה.
                        </p>
                        <div className="space-y-3">
                            <Link
